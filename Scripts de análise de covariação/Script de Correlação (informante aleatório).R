...
# Definir a função panel.cor() para plotar gráficos de dispersão, coeficientes de correlação e valores p
...
# Criar uma matriz de correlação com gráficos de dispersão, coeficientes de correlação e valores p
